...
Imports VRHImportAgent.Org.Mentalis.Files
Imports System.Globalization

Public Class frmVRHImportAgent
    ...
    Public Function SaveTextToFile(ByVal strData As String, ByVal FullPath As String, Optional ByVal ErrInfo As String = "") As Boolean
        ...
        Try
            objReader = New StreamWriter(FullPath, False, System.Text.Encoding.Unicode, strData.Length)
    ...
    '            '    LastMiss &= ",'" & dtrow.Item("Queue_no") & "'"
    '            'End If
    '            QinfoMisscall &= "&Queue_no" & j.ToString & "=" & dtrow.Item("Queue_no")
    '            j += 1
    '        Next
    '        If j < 33 Then
    '            For j = j To 33
    '                QinfoMisscall &= "&Queue_no" & j.ToString & "="
    '            Next
    '        End If
    ...
    Private Sub TimerDelMoveFile_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TimerDelMoveFile.Tick
        ...
        TimerDelMoveFile.Enabled = False
    End Sub

    Private Sub frmVRHImportAgent_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        TimerDelMoveFile.Enabled = True
    End Sub
End Class
