...
Imports VRHOrthoImportAgent.Org.Mentalis.Files
Imports System.Globalization

Public Class frmVRHOrthoImportAgent
            ...
            Try
                ...
                If DTQ.Rows.Count > 0 Then
                    ...
                    For rowindex As Integer = 0 To DTQ.Rows.Count - 1
                        ...
                        Qinfo &= CallCounterParm & (rowindex + 1) & "=" & CallCounter & Chr(13)
                ...
                ElseIf DTQ.Rows.Count = 0 Then
                    Qinfo &= CallCounterParm & "1=" & CallCounter & CallingQueueParm & "=" & Chr(13)
                End If
                DTQ.Clear()
                conn.Close()
            Catch ex As Exception
    ...
    Private Sub LoadConfig()
        ...
        CallCounter = iniReaderObj.ReadString("Setting", "CallCounter", "")
